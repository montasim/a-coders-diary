...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="footer p-10  bg-gradient-to-r from-primary to-secondary uppercase font-small text-white">
                <div>
                ...
                <div>
                    ...
                    <div className="form-control w-80">
                        <label className="label">
                            <span className="label-text text-info">Enter your email address to subscribe</span>
                        </label>
                        <div className="relative">
                            <input type="text" placeholder="youremail@email.com" className="input input-bordered w-full pr-16" />
            ...
            <footer className="footer px-10 py-4 bg-primary text-base-content border-base-300">
                ...
                <div className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4 items-center text-info">
            ...
            <footer className="footer footer-center p-4 bg-gradient-to-r from-secondary to-primary text-white">
                <div>
