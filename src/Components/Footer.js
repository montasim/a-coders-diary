...
const Footer = () => {
    ...
    return (
        <div>
            <footer class="footer p-10  bg-gradient-to-r from-primary to-secondary uppercase font-small text-white">
                ...
                <div>
                    ...
                    <div class="form-control w-80">
                        <label class="label">
                            <span class="label-text text-info">Enter your email address to subscribe</span>
                        </label>
                        <div class="relative">
            ...
            <footer class="footer px-10 py-4 bg-primary text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <h5 className='lg:text-xl sm:text-lg ml-4'>
                        <span className='uppercase bg-clip-text text-info font-bold'>A Coders Diary Blog.</span>
                        <br />
                        <small className='text-info'>Your Daily Tech Tips since 2022</small>
                    </h5>
                </div>
                <div class="md:place-self-center md:justify-self-end">
                    <div class="grid grid-flow-col gap-4 items-center text-info">
                        ...
                        <a href='https://www.facebook.com/mr.montasim/'>
            ...
            <footer class="footer footer-center p-4 bg-gradient-to-r from-secondary to-primary text-white">
                <div>
